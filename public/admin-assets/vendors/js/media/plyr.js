  ...
  function () {
    ...
    _createClass(Ads, [{
      ...
      value: function setupIMA() {
        ...
        this.elements.displayContainer = new google.ima.AdDisplayContainer(this.elements.container, this.player.media); // Requests video ads to be pre-loaded
